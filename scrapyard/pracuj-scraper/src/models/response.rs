...
pub struct JobOffer {
    ...
    pub company_profile_absolute_uri: Option<String>,
    pub company_id: u64,
    pub company_logo_uri: Option<String>,
    pub last_publicated: Option<String>,
    pub expiration_date: Option<String>,
    pub salary_display_text: Option<String>,
